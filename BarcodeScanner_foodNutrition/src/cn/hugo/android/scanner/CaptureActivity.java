...
import cn.hugo.android.scanner.foodfinder.BaseNutritionData;
import cn.hugo.android.scanner.foodfinder.FoodNutritionFinder;
...
public final class CaptureActivity extends Activity implements
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		Toast.makeText(this,
				"bar code:" + ResultParser.parseResult(rawResult).toString(),
				Toast.LENGTH_SHORT).show();
		
		FoodNutritionFinder fnFinder = new FoodNutritionFinder (this, new FoodNutritionFinder.FoodNutritionFinderListener() {
			
			@Override
			public void findFoodSuccess(BaseNutritionData bnd) {
				Log.i("YXH-->", bnd.toString());	
				
				Toast.makeText(CaptureActivity.this,
						"Food was founded!\n" + "name = "  +bnd.getFoodName() + "\n" +
				         "Brand = " + bnd.getFoodBrand() +"\n" + 
						 "Description = " + bnd.getFoodDescription(),
						Toast.LENGTH_SHORT).show();
			}
			
			@Override
			public void findFoodFailed(String error_message, String error_code,
					int status_code) {
				Toast.makeText(CaptureActivity.this,
						"Food can not be found!, " + error_message,
						Toast.LENGTH_SHORT).show();
				
			}
		});
		
		fnFinder.getFoodNutritionFromUPC (ResultParser.parseResult(rawResult).toString());
